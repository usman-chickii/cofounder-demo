...
const STAGE_KEY: ChatbotStage = "document_generation";
...
export const documentGenerationNode = new RunnableLambda<
  DocumentGenerationInput,
  { stage: ChatbotStage }
>({
  func: async ({ projectId, userMessage, onData }: DocumentGenerationInput) => {
